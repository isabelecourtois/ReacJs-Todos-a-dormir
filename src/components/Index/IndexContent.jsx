...
<div className="container-fluid p-0 overflow-hidden my-5">
	<div className="row g-0 mx-5">
		<div lc-helper="background" className="col-lg-4 order-lg-2 " style={{ minHeight: '45vh', backgroundSize: 'cover', backgroundPosition: 'center', backgroundImage: 'url(../../images/tad2.jpeg)'}}>
